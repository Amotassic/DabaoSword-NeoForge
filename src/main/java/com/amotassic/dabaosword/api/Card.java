...
public interface Card {
    ...
    enum Suits {
        Heart (Component.translatable("suit.heart")),
        Diamond (Component.translatable("suit.diamond")),
        Spade (Component.translatable("suit.spade")),
        Club (Component.translatable("suit.club"));

        public final Component suit;

        Suits(Component suit) {this.suit = suit;}

        public static Suits get(Component suit) { //获取对应的花色，如果填的String不是这4个，则随机获取一个
